...
----
$ git clone git@github.com:piyush1594/test-pipe
...
To interact with your booster while it's running local
[source,bash,options="nowrap",subs="attributes+"]
----
...
. Stop your booster.
+
NOTE: To stop your running booster in a Linux or macOS terminal, use `CTRL+C`. In a Windows command prom. Make your change (e.g. edit `src/main/resources/webroot/index.html`).
